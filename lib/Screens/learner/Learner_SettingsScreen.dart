...
class LearnerSettingsScreen extends StatelessWidget {
  const LearnerSettingsScreen({Key? key}) : super(key: key);
  static const String routeName = '/LearnerSettings';

  static Route route() {
    return MaterialPageRoute(builder: (_) => LearnerSettingsScreen());
  }
