...
class LearnerNavScreen extends StatefulWidget {
  const LearnerNavScreen({Key? key}) : super(key: key);
  static const String routeName = '/LearnerNav';

  static Route route() {
    return MaterialPageRoute(builder: (_) => LearnerNavScreen());
  }

  @override
  _LearnerNavScreenState createState() => _LearnerNavScreenState();
}

class _LearnerNavScreenState extends State<LearnerNavScreen>
  ...
  final screens = [
    ...
    const LearnerInstructorScreen(),
    const LearnerSettingsScreen(),
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context).pushNamed("/helpAndSupportScreen");
                },
                child: ListTile(
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10)),
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: [
          Column(
            ...
            children: [
              Icon(Icons.home, size: width * 0.06, color: Colors.white),
              Container(
