...
class LearnerProfileScreen extends StatelessWidget {
  ...
  static const String routeName = '/LearnerProfile';

  static Route route() {
    return MaterialPageRoute(builder: (_) => LearnerProfileScreen());
  }
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              GestureDetector(
                onTap: () {
                  Navigator.of(context).pushNamed('/LearnerEditProfile');
                },
                child: Padding(
