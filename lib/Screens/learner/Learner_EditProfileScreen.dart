...
class LearnerEditProfileScreen extends StatefulWidget {
  const LearnerEditProfileScreen({Key? key}) : super(key: key);
  static const String routeName = '/LearnerEditProfile';

  static Route route() {
    return MaterialPageRoute(builder: (_) => LearnerEditProfileScreen());
  }

  @override
  _LearnerEditProfileScreenState createState() =>
      _LearnerEditProfileScreenState();
}

class _LearnerEditProfileScreenState extends State<LearnerEditProfileScreen> {
